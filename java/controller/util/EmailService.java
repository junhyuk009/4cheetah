...
public class EmailService {
    ...
    // ✅ 발신자(인증 계정) = 동일해야 안전함
    private static final String FROM_EMAIL = "lshfood93@gmail.com";      // 예: your@gmail.com    
    private static final String PASSWORD   = "ixrjievackqeffms";      // 앱 비밀번호(16자리)
    ...
    public void sendPasswordResetCode(String toEmail, String code) {
        ...
        // ✅ 핵심: TLS 1.2 강제 (No appropriate protocol 해결용)
