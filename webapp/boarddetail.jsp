...
<style>
/* =========================
   Board Detail (Glass) - page only
========================= */
.header__right__icons .icon_search {
	display: none !important;
}

/* spad(템플릿) 위에 헤더 겹침 방지 느낌 */
...
/* =========================================
   ...
   - table(td) 폭이 이미지에 의해 늘어나는 현상 차단
   - CKEditor 이미지/figure 포함 대응
========================================= */

/* 1) 테이블이 "내용 폭"에 끌려가지 않게 고정 레이아웃 */
.bd-table {
...
.bd-content img, .bd-content video {
	...
	display: block;
	margin: 12px auto;
	border-radius: 0 !important; /* ✅ 네 요구(직각 이미지) 유지 */
}
