...
(function(){
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    function doFetch(keyword){
      ...
      // ✅ 페이지 전체(다른 스크립트 포함)에서 동일 키워드 중복 호출 방지
    ...
    function handleValueChanged(force){
      ...
      // ✅ IME 특성: 결과 뜬 직후 값이 잠깐 1글자로 튀는 경우(예: '흑') 방어
      //    방금 2글자 이상 검색을 보냈고 아주 최근이면, 그 '짧아짐' 이벤트는 무시해서
      //    hideResult / 재검색 스케줄이 발생하지 않게 막는다.
