...
<style>
/* =========================
   기존 검색/정렬/페이지네이션 UI 유지
   ✅ 검색 UI는 공용(style.css) Unified Search UI로 통일
   - anime-search-box / anime-reset-btn / anime-admin-btn 스타일은 여기서 제거함
========================= */

/* ✅ 정렬 토글이 select가 아니라 ul/li지만,
   혹시 다른 select가 있으면 공통으로도 잡고 싶을 때 */
