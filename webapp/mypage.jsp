...
/* ==========================
   ✅ Apple-like + Premium RPG HUD Rows (FINAL)
...
.cost-row{
	...
	font-size: 14.5px;            /* ✅ 여기 글씨 키운 곳(원하면 더 조절) */
	line-height: 1.2;
}
